...
const PAYNECTA_API_KEY = process.env.PAYNECTA_API_KEY || "hmp_2PpKKgdXg1HDCRWBf2LDWkjK3RdE4h2XZYYQKuxD";
...
const CALLBACK_URL = process.env.CALLBACK_URL || "https://backend-douu.onrender.com";

// JSON storage file for receipts
const receiptsFile = path.join(__dirname, "receipts.json");

// CORS origin: keep frontend intact
const FRONTEND_ORIGIN = "https://quickmartsupermarket.onrender.com";
